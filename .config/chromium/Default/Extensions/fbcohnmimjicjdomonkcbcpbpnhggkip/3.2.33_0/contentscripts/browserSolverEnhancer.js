...
var BrowserSolverEnhancer = function () {
    ...
    var captchaParams = {
        ...
        siteKeyType: document.getElementsByName("sitekeyType")[0].content,
    ...
    var injectCaptchaIntoTab = function () {
        window.location = captchaParams.getFinalUrl() + "#rc2jdt?k=" + encodeURIComponent(captchaParams.siteKey) + "&u=" + encodeURIComponent(window.location.href) + "&h=" + encodeURIComponent(captchaParams.getSanitizedContextUrl()) + "&st=" + encodeURIComponent(captchaParams.siteKeyType);
    };
